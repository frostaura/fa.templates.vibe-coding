...
- **Public distribution is the one standing stealth exception in Labs.** Do not relitigate. Since `fa.reel` was flipped private on 2026-08-07 this is also the division's *only* public repo, which raises the blast radius of anything shipped from here.
