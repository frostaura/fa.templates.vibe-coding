...
public sealed class TasksTool
{
    ...
    [McpServerTool(Name = "tasks_create", UseStructuredContent = true, OpenWorld = false), Description(
    ...
    [McpServerTool(Name = "tasks_list", ReadOnly = true, Idempotent = true, UseStructuredContent = true, OpenWorld = false), Description(
    ...
    [McpServerTool(Name = "tasks_delete", Destructive = true, Idempotent = true, OpenWorld = false), Description(
    ...
    [McpServerTool(Name = "tasks_clear", Destructive = true, Idempotent = true, OpenWorld = false), Description(
