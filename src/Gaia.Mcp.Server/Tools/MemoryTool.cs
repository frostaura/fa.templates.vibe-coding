...
public sealed class MemoryTool
{
    ...
    [McpServerTool(Name = "memory_remember", Idempotent = true, UseStructuredContent = true, OpenWorld = false), Description(
    ...
    [McpServerTool(Name = "memory_recall", ReadOnly = true, Idempotent = true, UseStructuredContent = true, OpenWorld = false), Description(
    ...
    [McpServerTool(Name = "memory_forget", Destructive = true, Idempotent = true, OpenWorld = false), Description(
    ...
    [McpServerTool(Name = "memory_clear", Destructive = true, Idempotent = true, OpenWorld = false), Description(
