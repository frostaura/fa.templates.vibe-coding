...
public sealed class EvolveTool
{
    ...
    [McpServerTool(Name = "evolve_log", UseStructuredContent = true, OpenWorld = false), Description(
    ...
    [McpServerTool(Name = "evolve_list", ReadOnly = true, Idempotent = true, UseStructuredContent = true, OpenWorld = false), Description(
    ...
    [McpServerTool(Name = "evolve_apply", Idempotent = true, OpenWorld = false), Description(
    ...
    [McpServerTool(Name = "evolve_clear", Destructive = true, Idempotent = true, OpenWorld = false), Description(
