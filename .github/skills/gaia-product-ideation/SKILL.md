...
Use this skill to diverge then converge from the Opportunity Thesis to ONE
concept. Scope is one-off + IAP/IAG monetization; B2B seat-based SaaS is out of
scope and an auto-renew anti-goal is mandatory unless an in-scope decision is
recorded.
