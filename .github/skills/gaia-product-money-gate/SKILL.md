...
| WTP unconfirmed by money | run a fake-door / ad test | `gaia-product-validation-researcher` |
| CPI > net LTV | re-tune economy or kill | `gaia-product-monetization-economist` |
| LTV>CAC but cash gap | confirm financing or descope | `gaia-product-monetization-economist` |
