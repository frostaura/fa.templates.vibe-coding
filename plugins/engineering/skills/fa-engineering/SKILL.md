...
- If the branch changes React UI, invoke `fa-ui-engineering` before editing components, classes, or layout behavior.
...
- route user-facing React UI work through `fa-ui-engineering` so design-system rules stay explicit during delivery
