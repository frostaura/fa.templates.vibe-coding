...
- If the branch changes React UI, invoke `fa-engineering-ui` before editing components, classes, or layout behavior.
...
- route user-facing React UI work through `fa-engineering-ui` so design-system rules stay explicit during delivery
